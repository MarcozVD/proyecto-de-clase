...
@section('title', 'Editar Producto - TIENDA AZUL')

@section('content')

<h1 style="text-align: center; margin-bottom: 30px;">✨ Editar tu Producto</h1>
                ...
                <div class="form-group">
                    ...
                    @if($product->image)
                        <div style="margin-bottom: 10px;">
                            <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" style="max-width: 100px; border-radius: 4px;">
